...
export default function AssetCard({ asset, onOpen }){
  return (
    <div onClick={()=>onOpen(asset)} className="cursor-pointer bg-white dark:bg-slate-900 rounded-lg border hover:shadow-lg p-4 flex items-center gap-4">
      <div className="flex-shrink-0 w-12 h-12 rounded bg-gray-100 dark:bg-slate-800 flex items-center justify-center">
      ...
      <div className="flex flex-col items-end gap-2">
        ...
        <div className="text-xs px-2 py-1 bg-gray-100 dark:bg-slate-800 text-gray-700 dark:text-gray-300 rounded">{asset.location}</div>
      </div>
    </div>
  )
}
